...
Citizen.CreateThread(function()
	TriggerServerEvent('nui_doorlock:getDoorInfo')
...
RegisterNetEvent('nui_doorlock:receiveDoorInfo')
AddEventHandler('nui_doorlock:receiveDoorInfo', function(doorInfo)
print(json.encode(doorInfo))
